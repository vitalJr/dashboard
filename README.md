...
```
cd existing_repo
git remote add origin https://gitlab.com/front-end100/affiliated.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/front-end100/affiliated/-/settings/integrations)
